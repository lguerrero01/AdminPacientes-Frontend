...
const Pacientes = ({citas}) => {
    ...
    return (
        <Fragment>
            <h1 className="my-5" >Gestionador de Pacientes </h1>
            <div className="container mt-5 my-5">
                ...
                <div className="col-md-8 mx-auto">
                    <div className="list-group">
                        {citas.map(cita =>  {                            
                          return (<Link to={`/cita/${cita._id}`} key={cita._id} className="p-5 list-group-item list-group-item-action flex-column align-items-start">
